...
using Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.Item;
using Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.Recommended;
...
using System;
namespace Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs
{
    /// <summary>
    ...
    public partial class ProgramsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.Recommended.RecommendedRequestBuilder Recommended
        {
            get => new global::Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.Recommended.RecommendedRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Gets an item from the Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.item collection</summary>
        /// <param name="position">Program id.</param>
        /// <returns>A <see cref="global::Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.Item.WithProgramItemRequestBuilder"/></returns>
        public global::Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.Item.WithProgramItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("programId", position);
                return new global::Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.Item.WithProgramItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.ProgramsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Jellyfin.OpenApiClient.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.ProgramsRequestBuilder.ProgramsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Jellyfin.OpenApiClient.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.ProgramsRequestBuilder.ProgramsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Jellyfin.OpenApiClient.Models.BaseItemDtoQueryResult?> PostAsync(global::Soenneker.Jellyfin.OpenApiClient.Models.GetProgramsDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Jellyfin.OpenApiClient.Models.BaseItemDtoQueryResult> PostAsync(global::Soenneker.Jellyfin.OpenApiClient.Models.GetProgramsDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.ProgramsRequestBuilder.ProgramsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.ProgramsRequestBuilder.ProgramsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Jellyfin.OpenApiClient.Models.GetProgramsDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Jellyfin.OpenApiClient.Models.GetProgramsDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.ProgramsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.ProgramsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Jellyfin.OpenApiClient.LiveTv.Programs.ProgramsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets available live tv epgs.
        /// </summary>
