...
using System;
namespace Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal.UniversalRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task HeadAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderHeadQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task HeadAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderHeadQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderHeadQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal.UniversalRequestBuilder.UniversalRequestBuilderHeadQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal.UniversalRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal.UniversalRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal.UniversalRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets an audio stream.
        /// </summary>
...
#nullable restore
            ...
            public global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.Universal.MediaStreamProtocol? TranscodingProtocol { get; set; }
