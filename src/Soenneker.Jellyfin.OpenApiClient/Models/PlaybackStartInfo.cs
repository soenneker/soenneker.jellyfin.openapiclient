...
#nullable restore
        ...
        public global::Soenneker.Jellyfin.OpenApiClient.Models.PlaybackStartInfo_PlaybackOrder? PlaybackOrder { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Jellyfin.OpenApiClient.Models.PlaybackStartInfo_PlayMethod? PlayMethod { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Jellyfin.OpenApiClient.Models.PlaybackStartInfo_RepeatMode? RepeatMode { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Jellyfin.OpenApiClient.Models.PlaybackStartInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Jellyfin.OpenApiClient.Models.PlaybackStartInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Jellyfin.OpenApiClient.Models.PlaybackStartInfo();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "PlayMethod", n => { PlayMethod = n.GetEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.PlaybackStartInfo_PlayMethod>(); } },
                { "PlaySessionId", n => { PlaySessionId = n.GetStringValue(); } },
                { "PlaybackOrder", n => { PlaybackOrder = n.GetEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.PlaybackStartInfo_PlaybackOrder>(); } },
                ...
                { "RepeatMode", n => { RepeatMode = n.GetEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.PlaybackStartInfo_RepeatMode>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.PlaybackStartInfo_PlaybackOrder>("PlaybackOrder", PlaybackOrder);
            writer.WriteLongValue("PlaybackStartTimeTicks", PlaybackStartTimeTicks);
            writer.WriteStringValue("PlaylistItemId", PlaylistItemId);
            writer.WriteEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.PlaybackStartInfo_PlayMethod>("PlayMethod", PlayMethod);
            writer.WriteStringValue("PlaySessionId", PlaySessionId);
            writer.WriteLongValue("PositionTicks", PositionTicks);
            writer.WriteEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.PlaybackStartInfo_RepeatMode>("RepeatMode", RepeatMode);
