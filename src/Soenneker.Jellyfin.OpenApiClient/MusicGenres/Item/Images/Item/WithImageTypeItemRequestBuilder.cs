...
using Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the Soenneker.Jellyfin.OpenApiClient.MusicGenres.item.Images.item.item collection</summary>
        ...
        public global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.Item.WithImageIndexItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("imageIndex", position);
                return new global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.Item.WithImageIndexItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.WithImageTypeItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.WithImageTypeItemRequestBuilder.WithImageTypeItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.WithImageTypeItemRequestBuilder.WithImageTypeItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> HeadAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.WithImageTypeItemRequestBuilder.WithImageTypeItemRequestBuilderHeadQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> HeadAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.WithImageTypeItemRequestBuilder.WithImageTypeItemRequestBuilderHeadQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.WithImageTypeItemRequestBuilder.WithImageTypeItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.WithImageTypeItemRequestBuilder.WithImageTypeItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.WithImageTypeItemRequestBuilder.WithImageTypeItemRequestBuilderHeadQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.WithImageTypeItemRequestBuilder.WithImageTypeItemRequestBuilderHeadQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.WithImageTypeItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.WithImageTypeItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.WithImageTypeItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get music genre image by name.
        /// </summary>
...
#nullable restore
            ...
            public global::Soenneker.Jellyfin.OpenApiClient.MusicGenres.Item.Images.Item.ImageFormat? Format { get; set; }
