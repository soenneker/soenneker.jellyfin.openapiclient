...
using Soenneker.Jellyfin.OpenApiClient.Genres.Item;
...
using System;
namespace Soenneker.Jellyfin.OpenApiClient.Genres
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the Soenneker.Jellyfin.OpenApiClient.Genres.item collection</summary>
        /// <param name="position">The genre name.</param>
        /// <returns>A <see cref="global::Soenneker.Jellyfin.OpenApiClient.Genres.Item.GenreNameItemRequestBuilder"/></returns>
        public global::Soenneker.Jellyfin.OpenApiClient.Genres.Item.GenreNameItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("genreName%2Did", position);
                return new global::Soenneker.Jellyfin.OpenApiClient.Genres.Item.GenreNameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Jellyfin.OpenApiClient.Genres.GenresRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Jellyfin.OpenApiClient.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Genres.GenresRequestBuilder.GenresRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Jellyfin.OpenApiClient.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Genres.GenresRequestBuilder.GenresRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Genres.GenresRequestBuilder.GenresRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Genres.GenresRequestBuilder.GenresRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Jellyfin.OpenApiClient.Genres.GenresRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Jellyfin.OpenApiClient.Genres.GenresRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Jellyfin.OpenApiClient.Genres.GenresRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets all genres from a given item, folder, or the entire library.
        /// </summary>
