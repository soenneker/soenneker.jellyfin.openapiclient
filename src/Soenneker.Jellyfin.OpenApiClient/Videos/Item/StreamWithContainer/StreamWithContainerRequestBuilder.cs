...
using System;
namespace Soenneker.Jellyfin.OpenApiClient.Videos.Item.StreamWithContainer
{
    /// <summary>
    ...
    public partial class StreamWithContainerRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StreamWithContainerRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{item%2Did}/stream.{container}{?allowAudioStreamCopy*,allowVideoStreamCopy*,audioBitRate*,audioChannels*,audioCodec*,audioSampleRate*,audioStreamIndex*,context*,copyTimestamps*,cpuCoreLimit*,deInterlace*,deviceId*,deviceProfileId*,enableAudioVbrEncoding*,enableAutoStreamCopy*,enableMpegtsM2TsMode*,framerate*,height*,level*,liveStreamId*,maxAudioBitDepth*,maxAudioChannels*,maxFramerate*,maxHeight*,maxRefFrames*,maxVideoBitDepth*,maxWidth*,mediaSourceId*,minSegments*,params*,playSessionId*,profile*,requireAvc*,requireNonAnamorphic*,segmentContainer*,segmentLength*,startTimeTicks*,static*,streamOptions,subtitleCodec*,subtitleMethod*,subtitleStreamIndex*,tag*,transcodeReasons*,transcodingMaxAudioChannels*,videoBitRate*,videoCodec*,videoStreamIndex*,width*}", rawUrl)
        {
        }
        /// <summary>
        /// Gets a video stream.
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Videos.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Videos.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> HeadAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Videos.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderHeadQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> HeadAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Videos.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderHeadQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Videos.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Videos.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderGetQueryParameters>> requestConfiguration = default)
        {
            ...
            requestInfo.Headers.TryAdd("Accept", "video/*");
            return requestInfo;
        }
        /// <summary>
        /// Gets a video stream.
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Videos.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderHeadQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Videos.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderHeadQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Jellyfin.OpenApiClient.Videos.Item.StreamWithContainer.StreamWithContainerRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Jellyfin.OpenApiClient.Videos.Item.StreamWithContainer.StreamWithContainerRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets a video stream.
        /// </summary>
...
#nullable restore
            ...
            public global::Soenneker.Jellyfin.OpenApiClient.Videos.Item.StreamWithContainer.EncodingContext? Context { get; set; }
...
#nullable restore
            ...
            /// <summary>Optional. The maximum vertical resolution of the encoded video.</summary>
            ...
            /// <summary>Optional. The maximum horizontal resolution of the encoded video.</summary>
...
#nullable restore
            ...
            public global::Soenneker.Jellyfin.OpenApiClient.Videos.Item.StreamWithContainer.SubtitleDeliveryMethod? SubtitleMethod { get; set; }
