...
using System;
namespace Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer.StreamWithContainerRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> HeadAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderHeadQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> HeadAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderHeadQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderHeadQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer.StreamWithContainerRequestBuilder.StreamWithContainerRequestBuilderHeadQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer.StreamWithContainerRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer.StreamWithContainerRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets an audio stream.
        /// </summary>
...
#nullable restore
            ...
            public global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer.EncodingContext? Context { get; set; }
...
#nullable restore
            ...
            public global::Soenneker.Jellyfin.OpenApiClient.Audio.Item.StreamWithContainer.SubtitleDeliveryMethod? SubtitleMethod { get; set; }
