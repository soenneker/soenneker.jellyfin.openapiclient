...
#nullable restore
        ...
        public global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingInfo_HardwareAccelerationType? HardwareAccelerationType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodeReason?>? TranscodeReasons { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodeReason?> TranscodeReasons { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingInfo();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "HardwareAccelerationType", n => { HardwareAccelerationType = n.GetEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingInfo_HardwareAccelerationType>(); } },
                { "Height", n => { Height = n.GetIntValue(); } },
                { "IsAudioDirect", n => { IsAudioDirect = n.GetBoolValue(); } },
                { "IsVideoDirect", n => { IsVideoDirect = n.GetBoolValue(); } },
                { "TranscodeReasons", n => { TranscodeReasons = n.GetCollectionOfEnumValues<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodeReason>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingInfo_HardwareAccelerationType>("HardwareAccelerationType", HardwareAccelerationType);
            writer.WriteIntValue("Height", Height);
            writer.WriteBoolValue("IsAudioDirect", IsAudioDirect);
            writer.WriteBoolValue("IsVideoDirect", IsVideoDirect);
            writer.WriteCollectionOfEnumValues<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodeReason>("TranscodeReasons", TranscodeReasons);
