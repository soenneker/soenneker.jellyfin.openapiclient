...
using Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.IndexNamespace;
using Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.Item;
...
using System;
namespace Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item
{
    /// <summary>
    ...
    public partial class WithImageIndexItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.IndexNamespace.IndexRequestBuilder Index
        {
            get => new global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.IndexNamespace.IndexRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Gets an item from the Soenneker.Jellyfin.OpenApiClient.Items.item.Images.item.item.item collection</summary>
        /// <param name="position">Optional. Supply the cache tag from the item object to receive strong caching headers.</param>
        /// <returns>A <see cref="global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.Item.WithTagItemRequestBuilder"/></returns>
        public global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.Item.WithTagItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("tag", position);
                return new global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.Item.WithTagItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.WithImageIndexItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.WithImageIndexItemRequestBuilder.WithImageIndexItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.WithImageIndexItemRequestBuilder.WithImageIndexItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Stream?> HeadAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.WithImageIndexItemRequestBuilder.WithImageIndexItemRequestBuilderHeadQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> HeadAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.WithImageIndexItemRequestBuilder.WithImageIndexItemRequestBuilderHeadQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.WithImageIndexItemRequestBuilder.WithImageIndexItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.WithImageIndexItemRequestBuilder.WithImageIndexItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.WithImageIndexItemRequestBuilder.WithImageIndexItemRequestBuilderHeadQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToHeadRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.WithImageIndexItemRequestBuilder.WithImageIndexItemRequestBuilderHeadQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.WithImageIndexItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.WithImageIndexItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets the item&apos;s image.
        /// </summary>
...
#nullable restore
            ...
            public global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Images.Item.Item.ImageFormat? Format { get; set; }
