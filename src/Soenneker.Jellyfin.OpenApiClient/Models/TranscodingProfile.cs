...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Jellyfin.OpenApiClient.Models.ProfileCondition>? Conditions { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Jellyfin.OpenApiClient.Models.ProfileCondition> Conditions { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_Context? Context { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_Protocol? Protocol { get; set; }
        /// <summary>Gets or sets the segment length.</summary>
        public int? SegmentLength { get; set; }
        /// <summary>Gets or sets the transcoding seek info mode.</summary>
        public global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_TranscodeSeekInfo? TranscodeSeekInfo { get; set; }
        /// <summary>Gets or sets the DLNA profile type.</summary>
        public global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_Type? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile"/> and sets the default values.
        /// </summary>
        public TranscodingProfile()
        {
            BreakOnNonKeyFrames = false;
            Context = global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_Context.Streaming;
            ...
            MinSegments = 0;
            SegmentLength = 0;
            TranscodeSeekInfo = global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_TranscodeSeekInfo.Auto;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "Conditions", n => { Conditions = n.GetCollectionOfObjectValues<global::Soenneker.Jellyfin.OpenApiClient.Models.ProfileCondition>(global::Soenneker.Jellyfin.OpenApiClient.Models.ProfileCondition.CreateFromDiscriminatorValue)?.AsList(); } },
                { "Container", n => { Container = n.GetStringValue(); } },
                { "Context", n => { Context = n.GetEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_Context>(); } },
                ...
                { "Protocol", n => { Protocol = n.GetEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_Protocol>(); } },
                { "SegmentLength", n => { SegmentLength = n.GetIntValue(); } },
                { "TranscodeSeekInfo", n => { TranscodeSeekInfo = n.GetEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_TranscodeSeekInfo>(); } },
                { "Type", n => { Type = n.GetEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_Type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Jellyfin.OpenApiClient.Models.ProfileCondition>("Conditions", Conditions);
            writer.WriteStringValue("Container", Container);
            writer.WriteEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_Context>("Context", Context);
            ...
            writer.WriteEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_Protocol>("Protocol", Protocol);
            writer.WriteIntValue("SegmentLength", SegmentLength);
            writer.WriteEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_TranscodeSeekInfo>("TranscodeSeekInfo", TranscodeSeekInfo);
            writer.WriteEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TranscodingProfile_Type>("Type", Type);
