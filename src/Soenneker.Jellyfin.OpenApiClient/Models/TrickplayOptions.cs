...
namespace Soenneker.Jellyfin.OpenApiClient.Models
{
    ...
    public partial class TrickplayOptions : IParsable
    {
        ...
        public global::Soenneker.Jellyfin.OpenApiClient.Models.TrickplayOptions_ProcessPriority? ProcessPriority { get; set; }
        ...
        public global::Soenneker.Jellyfin.OpenApiClient.Models.TrickplayOptions_ScanBehavior? ScanBehavior { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Jellyfin.OpenApiClient.Models.TrickplayOptions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Jellyfin.OpenApiClient.Models.TrickplayOptions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Jellyfin.OpenApiClient.Models.TrickplayOptions();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "ProcessPriority", n => { ProcessPriority = n.GetEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TrickplayOptions_ProcessPriority>(); } },
                { "ProcessThreads", n => { ProcessThreads = n.GetIntValue(); } },
                { "Qscale", n => { Qscale = n.GetIntValue(); } },
                { "ScanBehavior", n => { ScanBehavior = n.GetEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TrickplayOptions_ScanBehavior>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TrickplayOptions_ProcessPriority>("ProcessPriority", ProcessPriority);
            writer.WriteIntValue("ProcessThreads", ProcessThreads);
            writer.WriteIntValue("Qscale", Qscale);
            writer.WriteEnumValue<global::Soenneker.Jellyfin.OpenApiClient.Models.TrickplayOptions_ScanBehavior>("ScanBehavior", ScanBehavior);
