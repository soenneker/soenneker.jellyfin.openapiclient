...
using System;
namespace Soenneker.Jellyfin.OpenApiClient.Items.Item.Refresh
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Refresh.RefreshRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Refresh.RefreshRequestBuilder.RefreshRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Refresh.RefreshRequestBuilder.RefreshRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Refresh.RefreshRequestBuilder.RefreshRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Refresh.RefreshRequestBuilder.RefreshRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Refresh.RefreshRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Refresh.RefreshRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Refresh.RefreshRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Refreshes metadata for an item.
        /// </summary>
        ...
        public partial class RefreshRequestBuilderPostQueryParameters 
        {
            ...
            public global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Refresh.MetadataRefreshMode? ImageRefreshMode { get; set; }
            /// <summary>(Optional) Specifies the metadata refresh mode.</summary>
            [QueryParameter("metadataRefreshMode")]
            public global::Soenneker.Jellyfin.OpenApiClient.Items.Item.Refresh.MetadataRefreshMode? MetadataRefreshMode { get; set; }
